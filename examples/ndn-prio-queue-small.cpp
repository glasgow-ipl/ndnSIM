...
//bottleneck
  ...
  devicesConsumerLink.Add(consumerLink.Install (nodes.Get(1),nodes.Get(2)));
  devicesConsumerLink.Add(consumerLink.Install (nodes.Get(5),nodes.Get(2)));
  devicesConsumerLink.Add(consumerLink.Install (nodes.Get(6),nodes.Get(5)));

  NetDeviceContainer devicesProducerLink = producerLink.Install (nodes.Get(7),nodes.Get(3));
  devicesProducerLink.Add( producerLink.Install(nodes.Get(8),nodes.Get(3)));

  NetDeviceContainer devicesBottleneckLink = bottleneckLink.Install (nodes.Get(2),nodes.Get(3));
...
// Producer
  ...
  prioProducerHelper.Install(nodes.Get(8)); // last node
